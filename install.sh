...
CMD_NAME="mohith"
SSH_HOST="trolley.proxy.rlwy.net"   # TODO: switch to mohith.is-a.dev after DNS goes live
SSH_PORT="41074"
...
echo ""
echo -e "  (or connect directly:  ${CYAN}ssh trolley.proxy.rlwy.net -p ${SSH_PORT}${RESET})"
echo ""
